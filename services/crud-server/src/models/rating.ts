    ...
    create: async( RatingToCreate:IRating)=> {
        ...
        return new Promise((resolve,reject) => {
            ...
            pool.getConnection(function(err:any, connection:any){
                ...
                var sql = `INSERT INTO rating (rating_id, article_id, user_id, rating)
                VALUES (rating_id, ?, ?, ?);`; 

                connection.query(sql, [RatingToCreate.article_id, RatingToCreate.user_id, RatingToCreate.rating], function (error:any, results:IRating){
                    connection.release();
